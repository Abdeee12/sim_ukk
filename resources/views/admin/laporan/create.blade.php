                ...
                <form action="{{ route('siswa.laporan.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-6 border-b border-slate-700 pb-6">
                        ...
                        <div>
                            ...
                            <textarea name="detail_kegiatan" rows="6" class="w-full rounded-lg px-4 py-2" required placeholder="Jelaskan secara rinci apa yang Anda kerjakan hari ini..."></textarea>
                        </div>
                    </div>
