                    ...
                    <div class="mb-6 border-b border-slate-700 pb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            <div>
                                ...
                                <input type="time" name="jam_masuk" value="{{ old('jam_masuk') }}" class="w-full rounded-lg px-4 py-2 @error('jam_masuk') border-red-500 @enderror" required @if(isset($hasReportedToday) && $hasReportedToday) disabled @endif>
                            </div>
                            <div>
                                <label class="block text-slate-400 mb-2 text-sm">Jam Keluar (Opsional)</label>
                                <input type="time" name="jam_keluar" value="{{ old('jam_keluar') }}" class="w-full rounded-lg px-4 py-2 @error('jam_keluar') border-red-500 @enderror" @if(isset($hasReportedToday) && $hasReportedToday) disabled @endif>
                                @error('jam_keluar')
                        ...
                        <div>
                            ...
                            <textarea name="detail_kegiatan" rows="6" class="w-full rounded-lg px-4 py-2 @error('detail_kegiatan') border-red-500 @enderror" required @if(isset($hasReportedToday) && $hasReportedToday) disabled @endif placeholder="Jelaskan secara rinci apa yang Anda kerjakan hari ini...">{{ old('detail_kegiatan') }}</textarea>
