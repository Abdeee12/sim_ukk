    ...
    <div class="pt-24 pb-12 min-h-screen bg-[#0f172a] relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="flex flex-col md:flex-row justify-between items-center mb-8 animate-fade-in-up">
                ...
                <a href="<?php echo e(route('admin.siswa.create')); ?>" class="mt-4 md:mt-0 bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-white font-bold py-2 px-6 rounded-full shadow-[0_0_15px_rgba(6,182,212,0.5)] transition-all transform hover:scale-105">
                    + Tambah Siswa
                </a>
            </div>
                        ...
                        <tbody class="divide-y divide-slate-700">
                            <?php $__empty_1 = true; $__currentLoopData = $siswas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $siswa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="transition-colors hover-neon">
                                    ...
                                    <td class="px-6 py-4 font-bold text-white"><?php echo e($siswa->user->name); ?></td>
                                    <td class="px-6 py-4 font-mono text-cyan-200"><?php echo e($siswa->nisn); ?></td>
                                    <td class="px-6 py-4">
                                        <span class="bg-slate-700 px-2 py-1 rounded text-xs text-white"><?php echo e($siswa->kelas); ?></span>
                                        <span class="ml-2"><?php echo e($siswa->jurusan); ?></span>
                                    </td>
                                    <td class="px-6 py-4">
                                        <form action="<?php echo e(route('admin.siswa.assignMentor', $siswa->id)); ?>" method="POST" class="flex items-center space-x-2">
                                            <?php echo csrf_field(); ?>
                                            <select name="mentor_id" class="bg-slate-700 text-white px-2 py-1 rounded-md">
                                                ...
                                                <?php $__currentLoopData = $mentors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mentor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($mentor->id); ?>" <?php if(optional($siswa->mentor)->id == $mentor->id): ?> selected <?php endif; ?>><?php echo e($mentor->user->name); ?></option>
                                    ...
                                    <td class="px-6 py-4 text-center flex justify-center space-x-2">
                                        <a href="<?php echo e(route('admin.siswa.edit', $siswa->id)); ?>" class="text-yellow-400 hover:text-yellow-300 transition">Edit</a>
                                        <span class="text-slate-600">|</span>
                                        <form action="<?php echo e(route('admin.siswa.destroy', $siswa->id)); ?>" method="POST" onsubmit="return confirm('Yakin hapus data ini?');">
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\simm_ukk\resources\views/admin/siswa/index.blade.php ENDPATH**/ ?>