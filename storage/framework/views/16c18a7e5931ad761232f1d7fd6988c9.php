					...
					<table class="w-full text-sm text-left text-white">
						...
						<tbody>
							<?php $__currentLoopData = $laporans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lap): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<tr class="border-t border-slate-700" data-laporan-row="<?php echo e($lap->id); ?>">
									...
									<td class="px-4 py-3">
										<div class="flex items-center gap-2">
											...
											<button type="button" class="js-open-review text-white bg-green-600 hover:bg-green-500 text-xs px-2 py-1 rounded" data-action="<?php echo e(route('mentor.laporan.updateStatus', $lap)); ?>" data-status="approved">Approve</button>
											<button type="button" class="js-open-review text-white bg-red-600 hover:bg-red-500 text-xs px-2 py-1 rounded" data-action="<?php echo e(route('mentor.laporan.updateStatus', $lap)); ?>" data-status="rejected">Reject</button>
										</div>
									</td>
								</tr>
...
<?php /**PATH C:\xampp\htdocs\simm_ukk\resources\views/mentor/laporan/pending.blade.php ENDPATH**/ ?>