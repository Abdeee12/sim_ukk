                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
                            <div>
                                ...
                                <input type="text" name="nisn" 
                                       ...
                                       class="w-full rounded-lg px-4 py-2 font-mono <?php $__errorArgs = ['nisn'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> input-error <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="text" name="nomor_hp" 
                                       ...
                                       class="w-full rounded-lg px-4 py-2 font-mono <?php $__errorArgs = ['nomor_hp'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> input-error <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                    ...
                                    <option value="RPL" <?php echo e(old('jurusan') == 'RPL' ? 'selected' : ''); ?>>Rekayasa Perangkat Lunak</option>
                                    <option value="TKJ" <?php echo e(old('jurusan') == 'TKJ' ? 'selected' : ''); ?>>Teknik Komputer Jaringan</option>
                                    <option value="DKV" <?php echo e(old('jurusan') == 'DKV' ? 'selected' : ''); ?>>Desain Komunikasi Visual</option>
                                    <option value="AKL" <?php echo e(old('jurusan') == 'AKL' ? 'selected' : ''); ?>>Akuntansi</option>
                                    <option value="OTKP" <?php echo e(old('jurusan') == 'OTKP' ? 'selected' : ''); ?>>Otomatisasi Tata Kelola Perkantoran</option>
                                </select>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\simm_ukk\resources\views/admin/siswa/create.blade.php ENDPATH**/ ?>