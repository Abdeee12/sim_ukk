    ...
    <div class="pt-24 pb-12 min-h-screen relative overflow-hidden bg-[#0f172a]">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 relative z-10">
                ...
                <div class="bg-slate-900 rounded-[22px] p-6 relative overflow-hidden">
                    <div class="relative z-10 flex flex-col md:flex-row items-center justify-between">
                        ...
                        <div class="mt-4 md:mt-0 glass-dark px-6 py-3 rounded-xl text-center border-t-4 border-t-cyan-500">
                            ...
                            <div class="text-2xl font-mono font-bold text-white tracking-widest"><?php echo e(date('d M Y')); ?></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
                <a href="<?php echo e(route('mentor.laporan.pending')); ?>" class="group block h-full">
                    <div class="glass-dark rounded-3xl p-6 hover-neon h-full relative overflow-hidden group min-h-[220px] flex flex-col">
                        ...
                        <div class="flex items-start justify-between w-full mb-3">
                            ...
                            <div class="ml-4">
                                <div class="bg-slate-800 text-white text-sm font-bold px-3 py-1 rounded-full border border-slate-700"><?php echo e($pendingCount ?? 0); ?></div>
                            </div>
                        </div>
                        ...
                        <div class="flex-1 w-full">
                            <?php if(isset($pending) && $pending->count()): ?>
                                <ul class="space-y-2">
                                    <?php $__currentLoopData = $pending; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lap): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li class="text-sm text-slate-300 flex items-center justify-between">
                                            <a href="<?php echo e(route('mentor.laporan.show', $lap->id)); ?>" class="hover:underline"><?php echo e(optional($lap->siswa->user)->name ?? 'Siswa'); ?> — <?php echo e(\Carbon\Carbon::parse($lap->tanggal)->format('d M Y')); ?></a>
                                            <span class="text-xs text-slate-500 ml-4"><?php echo e(strtoupper($lap->status)); ?></span>
                                        </li>
                        ...
                        <div class="w-full mt-4 text-right">
                            <a href="<?php echo e(route('mentor.laporan.pending')); ?>" class="text-xs text-cyan-400 hover:underline">Lihat Semua →</a>
                        </div>
                    </div>
                </a>

                <a href="<?php echo e(route('mentor.laporan.rejected')); ?>" class="group block h-full">
                    <div class="glass-dark rounded-3xl p-6 hover-neon h-full relative overflow-hidden group min-h-[220px] flex flex-col">
                        ...
                        <div class="flex items-start justify-between w-full mb-3">
                            ...
                            <div class="ml-4">
                                <div class="bg-slate-800 text-white text-sm font-bold px-3 py-1 rounded-full border border-slate-700"><?php echo e($rejectedCount ?? 0); ?></div>
                            </div>
                        </div>

                        
                        <div class="flex-1 w-full">
                            <?php if(isset($rejected) && $rejected->count()): ?>
                                <ul class="space-y-2">
                                    <?php $__currentLoopData = $rejected; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lap): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li class="text-sm text-slate-300 flex items-center justify-between">
                                            <a href="<?php echo e(route('mentor.laporan.show', $lap->id)); ?>" class="hover:underline"><?php echo e(optional($lap->siswa->user)->name ?? 'Siswa'); ?> — <?php echo e(\Carbon\Carbon::parse($lap->tanggal)->format('d M Y')); ?></a>
                                            <span class="text-xs text-slate-500 ml-4"><?php echo e(strtoupper($lap->status)); ?></span>
                                        </li>
                        ...
                        <div class="w-full mt-4 text-right">
                            <a href="<?php echo e(route('mentor.laporan.rejected')); ?>" class="text-xs text-emerald-400 hover:underline">Lihat Semua →</a>
                        </div>
                    </div>
                </a>

                <a href="<?php echo e(route('mentor.laporan.completed')); ?>" class="group block h-full">
                    <div class="glass-dark rounded-3xl p-6 hover-neon h-full relative overflow-hidden group min-h-[220px] flex flex-col">
                        ...
                        <div class="flex items-start justify-between w-full mb-3">
                            ...
                            <div class="ml-4">
                                <div class="bg-slate-800 text-white text-sm font-bold px-3 py-1 rounded-full border border-slate-700"><?php echo e($completedCount ?? 0); ?></div>
                            </div>
                        </div>

                        
                        <div class="flex-1 w-full">
                            <?php if(isset($completed) && $completed->count()): ?>
                                <ul class="space-y-2">
                                    <?php $__currentLoopData = $completed; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lap): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li class="text-sm text-slate-300 flex items-center justify-between">
                                            <a href="<?php echo e(route('mentor.laporan.show', $lap->id)); ?>" class="hover:underline"><?php echo e(optional($lap->siswa->user)->name ?? 'Siswa'); ?> — <?php echo e(\Carbon\Carbon::parse($lap->tanggal)->format('d M Y')); ?></a>
                                            <span class="text-xs text-slate-500 ml-4"><?php echo e(strtoupper($lap->status)); ?></span>
                                        </li>
                        ...
                        <div class="w-full mt-4 text-right">
                            <a href="<?php echo e(route('mentor.laporan.completed')); ?>" class="text-xs text-indigo-400 hover:underline">Lihat Semua →</a>
                        </div>
                    </div>
                </a>
            </div>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\simm_ukk\resources\views/mentor/dashboard.blade.php ENDPATH**/ ?>