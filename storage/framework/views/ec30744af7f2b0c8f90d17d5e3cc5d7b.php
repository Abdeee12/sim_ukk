    ...
    <div class="pt-24 pb-12 min-h-screen relative overflow-hidden bg-[#0f172a]">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 relative z-10">
                ...
                <div class="bg-slate-900 rounded-[22px] p-8 relative overflow-hidden">
                    ...
                    <div class="relative z-10 flex flex-col md:flex-row items-center justify-between">
                        ...
                        <div class="mt-6 md:mt-0 glass-dark px-8 py-4 rounded-xl text-center border-t-4 border-t-cyan-500 shadow-lg">
                            ...
                            <div class="text-3xl font-mono font-bold text-white tracking-widest drop-shadow-[0_0_8px_rgba(6,182,212,0.8)]"><?php echo e(date('d M Y')); ?></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <a href="<?php echo e(route('admin.siswa.index')); ?>" class="group animate-card delay-100 block h-full">
                ...
                <a href="<?php echo e(route('admin.mentor.index')); ?>" class="group animate-card delay-200 block h-full">
                    <div class="glass-dark rounded-3xl p-8 hover-neon h-full relative overflow-hidden group">
                ...
                <a href="<?php echo e(route('admin.laporan.index')); ?>" class="group animate-card delay-300 block h-full">
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\simm_ukk\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>