...
<?php $component->withAttributes([]); ?>
    ...
    <div class="pt-24 pb-12 min-h-screen bg-[#0f172a] relative">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8 relative z-10">
            ...
            <!-- JUDUL -->
            <div class="mb-6">
                <a href="<?php echo e(route('admin.mentor.index')); ?>" class="text-emerald-400 hover:text-emerald-300 mb-2 inline-block transition-transform hover:-translate-x-1">&larr; Kembali ke Daftar Mentor</a>
            ...
            <div class="glass-dark rounded-2xl p-8 border-l-4 border-emerald-500">
                <form action="<?php echo e(route('admin.mentor.update', $mentor->id)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('PUT'); ?> <!-- PENTING: Method PUT untuk Update -->
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="name" 
                                       value="<?php echo e(old('name', $mentor->user->name)); ?>" 
                            ...
                            <div>
                                ...
                                <input type="email" name="email" 
                                       value="<?php echo e(old('email', $mentor->user->email)); ?>" 
                                       class="w-full rounded-lg px-4 py-2" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="nama_perusahaan" 
                                   value="<?php echo e(old('nama_perusahaan', $mentor->nama_perusahaan)); ?>" 
                                   class="w-full rounded-lg px-4 py-2" required>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="text" name="jabatan" 
                                       value="<?php echo e(old('jabatan', $mentor->jabatan)); ?>" 
                                       class="w-full rounded-lg px-4 py-2" required>
                            </div>
                            <div>
                                <label class="block text-slate-400 mb-2 text-sm">Nomor HP</label>
                                <input type="text" name="no_hp" 
                                       value="<?php echo e(old('no_hp', $mentor->no_hp)); ?>" 
                    ...
                    <div class="flex justify-end mt-8 space-x-4">
                         <a href="<?php echo e(route('admin.mentor.index')); ?>" class="px-6 py-3 rounded-xl border border-slate-600 text-slate-300 hover:bg-slate-800 transition">Batal</a>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\simm_ukk\resources\views/admin/mentor/edit.blade.php ENDPATH**/ ?>